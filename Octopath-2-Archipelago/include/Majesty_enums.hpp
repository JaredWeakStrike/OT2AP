...
enum class EACTION_COMMAND_USEABLE {
    eUSEABLE = 0,
    eDISABLE = 1,
    eCOMMAND_SEAL = 2,
...
enum class EADDITIVE_ORDER_CATEGORY {
    eALL = 0,
    eRERAISE = 1,
    eFIRST_ATTACK = 2,
    eLAST_ATTACK = 3,
...
enum class EADDITIVE_ORDER_TYPE {
    eREFLECTION = 0,
    eCOUNTER = 1,
    eCHASE_ATTACK = 2,
    eDOUBLE_ATTACK = 3,
...
enum class EADD_MEMBER_END_STATUS {
    eNONE = 0,
...
enum class EAILMENT_REMOVE_DISEASE_TYPE {
    eALL = 0,
    eDECONDITION_ALL = 1,
    eBUFF_ALL = 2,
    eDEBUFF_ALL = 3,
...
enum class EAILMENT_TARGET_TYPE {
    eDEPEND = 0,
    eENFORCER = 1,
    eRANDOM = 2,
    ePARTY_ALL = 3,
...
enum class EAWAKENING_MONSTER_PARAM {
    NONE = 0,
    NORMAL = 1,
    AWAKENING = 2,
    AWAKENING_AFTER = 3,
...
enum class EAcqImageResourceType {
    Texture = 0,
    Material = 1,
    EAcqImageResourceType_MAX = 2,
};

enum class EActivityInfoType {
    NONE = 0,
    MAIN_STORY = 1,
    EActivityInfoType_MAX = 2,
};

enum class EActivityTaskStatus {
    INIT = 0,
    START = 1,
    COMPLETED = 2,
...
enum class EBARMENU_STORY_PROGRESSTYPE {
    eNONE = 0,
    ePROGRESS = 1,
    eINTERRUPTION = 2,
    eCLEARED = 3,
...
enum class EBARMENU_STORY_SELECT_ITEM_TYPE {
    NOT_PROGRESSIVE = 0,
...
enum class EBARMENU_STORY_SELECT_STATE {
    eNONE = 0,
    eOPEN = 1,
    eSELECT = 2,
    eDIALOG = 3,
...
enum class EBATTLERESULT_BONUS_TYPE {
    eBONUS_TYPE_BREAK = 0,
...
enum class EBATTLERESULT_STATE {
    eNONE = 0,
    eOPEN = 1,
    eUPDATE = 2,
    eSUBPARTY_UPDATE = 3,
...
enum class EBATTLE_ACTION_ORDER_ESTIMATE_TYPE {
    eNONE = 0,
    eTOP = 1,
    eFIRST = 2,
    eGUARD = 3,
...
enum class EBATTLE_ACTION_TYPE {
    IDLE = 0,
    BOOST_IDLE = 1,
    STEP_IN = 2,
    STEP_OUT = 3,
...
enum class EBATTLE_AI_SUB_STATE {
    eSUB_STATE_NONE = 0,
    eSUB_STATE_01 = 1,
    eSUB_STATE_02 = 2,
    eSUB_STATE_03 = 3,
...
enum class EBATTLE_CAMERA_SEQUENCE {
...
enum class EBATTLE_COMMAND_ATTRIBUTE_ICON {
    eSWORD = 0,
    eLANCE = 1,
    eDAGGER = 2,
    eAXE = 3,
...
enum class EBATTLE_DAMAGE_TYPE {
    NORMAL = 0,
    WEAKNESS = 1,
    CRITICAL = 2,
    JUST_BREAK = 3,
...
enum class EBATTLE_DEBUG_SWITCH {
    eDEBUG_TYPE_NONE = 0,
    ePARTY_NO_DAMAGE = 1,
    eENEMY_NO_DAMAGE = 2,
    ePARTY_NOKO = 3,
...
enum class EBATTLE_DRAG_IN_TYPE {
    eDRAG_IN_COMMON = 0,
    eDRAG_IN_SEA = 1,
    eDRAG_IN_SAND_S = 2,
    eDRAG_IN_SAND_L = 3,
...
enum class EBATTLE_EFFECT_ATTACH_TYPE {
    eATTACH_NONE = 0,
    eATTACH_ENFORCER = 1,
    eATTACH_TARGET = 2,
    eATTACH_OWNAREA = 3,
...
enum class EBATTLE_ENCOUNT_TYPE {
    eNORMAL = 0,
    eEVENT = 1,
    eBOUT = 2,
    eINVADE = 3,
...
enum class EBATTLE_REPLAY_CHARA_STATUS {
    eREPLAY_ALIVE = 0,
    eREPLAY_PINCH = 1,
...
enum class EBATTLE_REPLAY_FIELD_STATUS {
...
enum class EBATTLE_REPLAY_FINISH_TYPE {
    eNORMAL = 0,
    eADDITIVE = 1,
    eCOUNTER = 2,
    eREFLECTION = 3,
...
enum class EBATTLE_RESULT_TYPE {
    eNONE = 0,
    eNORMAL = 1,
...
enum class EBATTLE_SEQUENCER_CHANGE_TYPE {
    START = 0,
    END = 1,
    LOOP = 2,
    SHUTDOWN = 3,
...
enum class EBATTLE_SEQUENCE_PATTERN_TYPE {
    ePATTERN_NONE = 0,
    ePATTERN_A = 1,
    ePATTERN_B = 2,
    ePATTERN_C = 3,
...
enum class EBATTLE_START_DASH_TYPE {
    eNONE = 0,
    eNORMAL = 1,
    eADVANTAGE = 2,
    eBACK_ATTACK = 3,
...
enum class EBATTLE_TARGET_TYPE {
    eSELF = 0,
    ePARTY_SINGLE = 1,
    ePARTY_ALL = 2,
    eENEMY_SINGLE = 3,
...
enum class EBATTLE_VIEWER_MODE {
    eNORMAL = 0,
    eUSE_ENEMY_GROUP = 1,
    eUSE_ENEMY_LIST = 2,
...
enum class EBATTLE_WARP_OFFSET_TYPE {
...
enum class EBATTLE_WEAK_ATTRIBUTE_TYPE {
    eSWORD = 0,
    eLANCE = 1,
    eDAGGER = 2,
    eAXE = 3,
...
enum class EBattlePlacementType {
    TEST_PLACEMENT_00 = 0,
    TEST_PLACEMENT_01 = 1,
    TEST_PLACEMENT_02 = 2,
    TEST_PLACEMENT_03 = 3,
...
enum class EBuildingPartsGroup {
...
enum class ECHANGE_TIME_DILATION {
    eNONE = 0,
...
enum class ECHARACTER_GRID_PANEL_WIDGET_STATE {
    eNone = 0,
    eOpening = 1,
    eRunning = 2,
    eClosing = 3,
...
enum class ECHARACTER_MODE {
    FIELD = 0,
    BATTLE = 1,
    ECHARACTER_MAX = 2,
};

enum class ECHARACTER_PARAM_TYPE {
    HP = 0,
    MP = 1,
    BP = 2,
    SP = 3,
...
enum class ECOMMAND_SEALING_TYPE {
...
enum class ECOMMAND_SUB_MENU_TYPE {
    eNONE = 0,
    eUNIQUE = 1,
    eDEFAULT_JOB = 2,
    eEXTEND_JOB = 3,
...
enum class ECOMMON_NOTIFICATION_STATE {
    eUI_NONE = 0,
    eUI_OPEN = 1,
    eUI_WAIT = 2,
    eUI_MESSAGE_IN = 3,
...
enum class ECONTROL_GUIDE_BUTTON_TYPE {
    eNONE = 0,
    eBUTTON_A = 1,
    eBUTTON_B = 2,
    eBUTTON_Y = 3,
...
enum class ECharacterMoveModeForDB {
    DEFAULT = 0,
    WALK = 1,
    LADDER = 2,
    CANOE = 3,
...
enum class ECommonNotificationType {
    Normal = 0,
    BadConnection = 1,
    ECommonNotificationType_MAX = 2,
};

enum class EControllerInputType {
    TYPE_UNKNOWN = 0,
...
enum class ECreditFontColor {
    COLOR_A = 0,
    COLOR_B = 1,
    COLOR_MAX = 2,
};

enum class ECreditFontSize {
    SMALL = 0,
    MIDDLE = 1,
    LARGE = 2,
...
enum class ECreditFontType {
    NORMAL = 0,
    TITLE = 1,
    ECreditFontType_MAX = 2,
};

enum class ECreditWidgetStyle {
    NO_STYLE = 0,
    TEXT_TITLE = 1,
    TEXT_SUBTITLE = 2,
    TEXT_SUBTITLE_2 = 3,
...
enum class EDAMAGE_UI_COLOR_TYPE {
...
enum class EDBNoticeType {
    LOADED = 0,
    UNLOADED = 1,
    EDBNoticeType_MAX = 2,
};

enum class EDB_LOAD_TIMING {
    ULTRA_FIRST = 0,
    FIRST = 1,
    IN_GAME = 2,
    ANY_TIME = 3,
...
enum class EDEBUFF_ATTACHSOCKET_TYPE {
    eBLIND = 0,
    eSTUN = 1,
    eETC = 2,
    eUI_DAMAGE = 3,
...
enum class EDEBUG_BATTLE_LOG_CATEGORY {
    eNONE = 0,
    eBATTLE_FLOW = 1,
    eCHARACTER = 2,
    eSEQUENCER = 3,
...
enum class EDEBUG_INFORMATION_COLOR_TYPE {
    eNutoral = 0,
    eActive = 1,
    eNegative = 2,
...
enum class EDISEASE_RESIST_TYPE {
    ePOISON = 0,
    eSILENCE = 1,
    eBLIND = 2,
    eCONFUSION = 3,
...
enum class EDISEASE_TYPE_BITMASK {
    ePOISON = 0,
    eSILENCE = 1,
    eBLIND = 2,
    eCONFUSION = 3,
...
enum class EDISMANTLING_EFFECT_TYPE {
    eNONE = 0,
    eHP_RECOVERY = 1,
    eSP_RECOVERY = 2,
    eBP_RECOVERY = 3,
...
enum class EDebugCanvasPrimType {
    Line = 0,
    Triangle = 1,
    Box = 2,
...
enum class EDismantlingData {
    TEST_DISMANTLING_DATA = 0,
    TEST_DISMANTLING_MAX = 1,
};

enum class EEEFFECT_DB {
...
enum class EENDROLL_ENEMY_DISEASE_BITMASK {
    eNONE = 0,
    ePOISON = 1,
    eSILENCE = 2,
    eBLIND = 3,
...
enum class EENDROLL_PARTY_DISEASE_BITMASK {
    eNONE = 0,
    ePOISON = 1,
    eSILENCE = 2,
    eBLIND = 3,
...
enum class EEQUIPMENT_ALL_CHARA_STATE {
    eNONE = 0,
    eCATEGORY_SELECT = 1,
    eSELECT_LIST = 2,
...
enum class EEQUIPMENT_ITEM_PARAM {
    eMAX_HP = 0,
    eMAX_MP = 1,
    eATK = 2,
    eMATK = 3,
...
enum class EEQUIPMENT_MENU_STATE {
    eNONE = 0,
    eOPEN = 1,
    eCLOSE = 2,
...
enum class EEQUIPMENT_RECOMENNDED_TYPE {
...
enum class EEVENTGAMEOVER_STATE {
    eINIT = 0,
    eSTART_FADE = 1,
    eWAIT = 2,
    eFINISH_FADE = 3,
...
enum class EEXTRA_STORY_CATEGORY {
    NONE = 0,
    CPL_GAK_SHO = 1,
    CPL_KUS_KAR = 2,
    CPL_ODO_KEN = 3,
...
enum class EEncountTableType {
    eET_VOLUME = 0,
    eET_TRIGGER = 1,
    eET_MAX = 2,
};

enum class EEncountTrigger {
    ENT_EMPTY = 0,
    ENT_MAX = 1,
};

enum class EEndRollFlowState {
    NONE = 0,
    INIT = 1,
    INIT_WAIT_SELF = 2,
    INIT_WAIT_OTHER = 3,
...
enum class EEndRollSegmentState {
    NONE = 0,
...
enum class EEventPostProcess {
    MONO = 0,
    DEEP_THINKING = 1,
    MAX = 2,
};

enum class EEventTheater {
    NONE = 0,
    UPDATE = 1,
    RESTORE = 2,
    FINISH_PRE = 3,
...
enum class EFADE_KIND {
    FADE = 0,
    EFADE_MAX = 1,
};

enum class EFADE_TYPE {
    NONE = 0,
    FADE_IN = 1,
    FADE_OUT = 2,
    EFADE_MAX = 3,
...
enum class EFIELDCOMMAND_BEG_STATE {
    eNONE = 0,
    eOPEN = 1,
    eLIST = 2,
    eEXEC_BEG = 3,
...
enum class EFIELDCOMMAND_LURE_STATE {
    eNONE = 0,
    eOPEN = 1,
    eDIALOG = 2,
    eCHANGE_DIALOG = 3,
...
enum class EFIELDCOMMAND_MENUITEM_STATE {
    eNONE = 0,
    eOPEN = 1,
    eUPDATE = 2,
    eDECIDE = 3,
...
enum class EFIELDCOMMAND_MONSTER_STATE {
    eNONE = 0,
    eOPPONENT_DIALOG = 1,
...
enum class EFIELDCOMMAND_PURCHASE_STATE {
    eNONE = 0,
    eOPEN = 1,
    eLIST = 2,
    ePURCHASE_CONFIRM = 3,
...
enum class EFIELDCOMMAND_SEARCH_STATE {
    eNONE = 0,
    eOPEN = 1,
    eOPEN_SEARCH = 2,
    eOPEN_BRIBERY = 3,
...
enum class EFIELD_DISEASE_REMOVE_TYPE {
    eNONE = 0,
    eTURN_COUNT = 1,
    eENFORCER_BREAK = 2,
...
enum class EFIELD_DISEASE_TYPE {
    eNONE = 0,
    eBURNING_FIELD = 1,
...
enum class EFieldCommandCategory {
    eRight = 0,
    eEvil = 1,
    eNight = 2,
...
enum class EFieldCommandPreviewMenuState {
    eNone = 0,
    eOpen = 1,
    eInTab = 2,
    eInPanel = 3,
...
enum class EFieldCommandSpecialPopupType {
    eNone = 0,
    ePartner_Akara = 1,
    ePartner_Mahina = 2,
...
enum class EFlagRandomControlTrigger {
    eLevelChange = 0,
    eTimeZoneChange = 1,
    EFlagRandomControlTrigger_MAX = 2,
};

enum class EFlashbackSequence {
    INIT = 0,
    START = 1,
    FINISH = 2,
...
enum class EGAMEOVER_TYPE {
    eDEFAULT = 0,
    eEVENT_RESTART = 1,
    EGAMEOVER_MAX = 2,
};

enum class EGAME_CONDITION_TYPE {
    eNONE = 0,
    eSOLO = 1,
    ePARTY = 2,
    ePLAYER_MALE = 3,
...
enum class EGET_DATATABLE_RESULT {
    Success = 0,
    NotFound = 1,
    NotMatch = 2,
...
enum class EHOLY_TORCH_SHINING_STATE {
    eNONE = 0,
    eSMALL = 1,
    eMIDIUM = 2,
    eLARGE = 3,
...
enum class EHUNTER_PARTNER_OFFSET_TYPE {
    CANOE_FR = 0,
    CANOE_BK = 1,
    CANOE_L = 2,
    CANOE_R = 3,
...
enum class EINITIAL_OPTION_WIDGET_STATE {
    eNone = 0,
    eOpening = 1,
    eOpend = 2,
    eWaitingSave = 3,
...
enum class EITEM_SPECIAL_EFFECT {
    NONE = 0,
    eUnrecoverable = 1,
    eHpAndMpAll = 2,
    ePoisonSolve = 3,
...
enum class EInventorEventState {
    NONE = 0,
    CHECK_RESOURCE = 1,
...
enum class EInventorLearnAbility {
    NONE = 0,
    LEARN_ABILITY = 1,
...
enum class EJudgeFastTravelAvailableResponse {
    Available = 0,
...
enum class EKSAudioComponentType {
    BGM_Common = 0,
    BGM_Interrupt = 1,
    SE = 2,
    SE_Env = 3,
...
enum class EKSCharacterAnimationLoop {
    NONE = 0,
    ONESHOT = 1,
    LOOP = 2,
    ONESHOT_STOP = 3,
...
enum class EKSCharacterCategory {
    NONE = 0,
    PLAYER = 1,
    NPC = 2,
    EVENT = 4,
...
enum class EKSCharacterMoveMode {
    WALK = 0,
    DASH = 1,
    EX_DASH = 2,
    LADDER = 3,
...
enum class EKSDeviceVolumeType {
    TV = 0,
    BUILT_IN_SPEAKER = 1,
    STEREO_JACK = 2,
...
enum class EKSDspBusType {
    DEFAULT = 0,
    REVERB_DUNGEON = 1,
    EKSDspBusType_MAX = 2,
};

enum class EKSEVENT_PLAY {
    NORMAL = 0,
    SINGLE = 1,
    EKSEVENT_MAX = 2,
};

enum class EKSFontType {
    Common = 0,
    Talk = 1,
    CustomTalk = 2,
    NonLocalization = 3,
...
enum class EKSImageFormats {
    JPG = 0,
    PNG = 1,
    EKSImageFormats_MAX = 2,
};

enum class EKSInputMode {
    MODE_CHARA = 0,
    MODE_UI = 1,
    MODE_MAX = 2,
};

enum class EKSKeyConfigElement {
...
enum class EKSSaveDataFlagType {
    CREATED_SYS_DATA = 0,
    VOICE_LANGUAGE = 1,
...
enum class EKSSaveDataParamType {
    VOLUME_VOICE = 0,
    VOLUME_BGM = 1,
    VOLUME_SE = 2,
    VOLUME_SE_ENV = 3,
...
enum class EKeyboardLayoutType {
    TYPE_NORMAL = 0,
    TYPE_ITALIAN = 1,
    TYPE_FRENCH = 2,
    TYPE_SPANISH = 3,
...
enum class ELISTWIDGET_SE_TYPE {
    OPEN = 0,
    DECIDE_CLOSE = 1,
    CANCEL_CLOSE = 2,
    SELECT = 3,
...
enum class ELIST_CHARACTER_CHANGE_STATE {
    eNONE = 0,
    eOPEN = 1,
    eCHARACTER_SELECT = 2,
...
enum class ELIST_ITEM_NEXT_SPACE {
    eNONE = 0,
    eSPACE = 1,
    eDIVIDER = 2,
...
enum class ELIST_NUM_UNIT_TYPE {
    ePRICE = 0,
    ePERCENT = 1,
    eLEVEL = 2,
    eNONE = 3,
...
enum class ELOADING_REASON {
    SINGLE = 0,
    FADE = 1,
    ELOADING_MAX = 2,
};

enum class ELevelLoaderNotice {
    NONE = 0,
    LOADED = 1,
    UNLOADED = 2,
    SHOWN = 3,
...
enum class ELevelLoaderRequest {
    NONE = 0,
    LOAD = 1,
    UNLOAD = 2,
    SHOW = 3,
...
enum class ELevelTransitionNotice {
    NONE = 0,
...
enum class EMAINMENU_ABILITYSETTING_STATE {
    eNONE = 0,
    eOPEN = 1,
    eSUBMENU = 2,
...
enum class EMAINMENU_SEQ_MISSIONRECORD {
    eNONE = 0,
    eWAIT = 1,
    eOPEN = 2,
    eMAIN_SELECT = 3,
...
enum class EMAINMENU_SEQ_STATE {
    eNONE = 0,
    eOPEN = 1,
    eUPDATE = 2,
    eCLOSE = 3,
...
enum class EMAINMENU_SUBJOB_COMFIRMRETURN {
    eCURSOR_LEFT = 0,
    eCANCEL_EVENT = 1,
    eSHOULDER_R = 2,
    eSHOULDER_L = 3,
...
enum class EMAIN_STORY_CATEGORY {
    NONE = 0,
    COMMON = 1,
    CHARA_PROLOGUE = 2,
    CHARA_FINAL = 3,
...
enum class EMANAGER_CREATE_PHASE {
    ULTRA_FIRST = 0,
    FIRST = 1,
    IN_GAME = 2,
    ANY_TIME = 3,
...
enum class EMAP_NAME_NOTIFICATION_OPEN_OWNER {
    eDEFAULT = 0,
    eEVENT = 1,
    EMAP_NAME_NOTIFICATION_OPEN_MAX = 2,
};

enum class EMISSIONRECORD_PARTYCHAT_STATE {
    eNONE = 0,
    eSELECT = 1,
    eCONFIRM_DIALOG = 2,
...
enum class EMISSIONRECORD_TYPE {
    eNONE = 0,
    eMAIN_MISSION = 1,
    eSUB_MISSION = 2,
    eEXTRA_MISSION = 3,
...
enum class EMISSION_RECORD_GAUGE_COLOR {
    eAREA = 0,
    eBLUE = 1,
    eRED = 2,
    eGREEN = 3,
...
enum class EMUSIC_PLAYER_WIDGET_STATE {
    eNone = 0,
    eOpening = 1,
    eOpend = 2,
    ePlaying = 3,
...
enum class EMYSHIP_CUSTOM_PART {
    COLOR = 0,
    SAIL = 1,
    MAX_NUM = 2,
...
enum class EMYSHIP_CUSTOM_TYPE {
    NONE = 0,
    TYPE_A = 1,
    TYPE_B = 2,
    TYPE_C = 3,
...
enum class EMainScenarioChapter {
    NONE = 0,
    CHAPTER1 = 1,
    CHAPTER1_COMPLETE = 2,
    CHAPTER2 = 3,
...
enum class ENARRATION_MESSAGE_STATE {
    eNONE = 0,
    eUPDATE = 1,
    eFADE_UPDATE = 2,
...
enum class ENextPurposeDataType {
    eNP_DATA = 0,
    eNP_DATA_LIST = 1,
    eNP_MAX = 2,
};

enum class ENpcSwoonType {
    eNone = 0,
    eSwoon = 1,
    eSleep = 2,
    ENpcSwoonType_MAX = 3,
...
enum class EOPTION_WIDGET_KIND {
    eToggleButton = 0,
    eSlider = 1,
    eButton = 2,
...
enum class EPARTNER_SELECT_SEQ {
    eNONE = 0,
    eOPEN_PROCESS = 1,
    eDIALOG_RUNNING = 2,
    eCLOSE_SELF = 3,
...
enum class EPARTYCHANGE_CHARACTERCHANGE_STATE {
    eNONE = 0,
    FADE_OUT_START = 1,
    FADE_OUT_WAIT = 2,
    FADE_IN_START = 3,
...
enum class EPARTYCHANGE_FADE_STATE {
    eNONE = 0,
    FADE_OUT_START = 1,
    FADE_OUT_WAIT = 2,
    ON_FADE_OUT_PROC = 3,
...
enum class EPARTY_PANEL_CHARA_COLOR_TYPE {
    eDEFAULT = 0,
    eDISABLE = 1,
    EPARTY_PANEL_CHARA_COLOR_MAX = 2,
};

enum class EPARTY_SPLIT_CLOSE_REASON {
    eNone = 0,
    eCanceled = 1,
    eCompleted = 2,
...
enum class EPARTY_SPLIT_PLACEMENT_POSITION {
    eMain = 0,
    eWilderness = 1,
    eDesert = 2,
    eIsland = 3,
...
enum class EPARTY_SPLIT_WIDGET_STATE {
    eNone = 0,
...
enum class EPLAYER_JOB_FB_TYPE {
    eIDLE = 0,
    eSELECT = 1,
    eSELECT_LOOP = 2,
...
enum class EPLAYER_SELECT_FB_PATTERN {
    eDEFAULT = 0,
    ePATTERN_1 = 1,
    ePATTERN_2 = 2,
...
enum class EPLAYER_SELECT_FB_TYPE {
    eIDLE = 0,
    eIDLE_LOOP = 1,
    eSELECT_DAY = 2,
    eSELECT_NIGHT = 3,
...
enum class EPOTENTIALITY_ACTION_TYPE {
    eNONE = 0,
    eADD_ABILITY = 1,
    eSKILL_ALL = 2,
    eCONVERGENCE = 3,
...
enum class ERADARMAP_ICONANIMATION_STATE {
    eNONE_STATE = 0,
    eTO_INSIDE_STATE = 1,
...
enum class ERADARMAP_ICON_OBJ_TYPE {
    NONE = 0,
    FIELD_NPC = 1,
    MAP_OBJECT = 2,
    EVENT_TRIGGER = 3,
...
enum class ERADARMAP_ICON_TYPE {
    ePLAYER = 0,
    eSAVEPOINT = 1,
    eTREASUREBOX = 2,
...
enum class ERECOVERY_EFFECT_TYPE {
    eNONE = 0,
    eHP = 1,
    eMP = 2,
    ePOTENTIAL = 3,
...
enum class EREMINISCENCE_MERGE_DATA {
    MONEY = 0,
    ITEM = 1,
    EQUIPMENT = 2,
    EQUIP_JOB = 3,
...
enum class EREMINISCENCE_MERGE_TYPE {
    NO_MERGE = 0,
    MERGE = 1,
    EREMINISCENCE_MERGE_MAX = 2,
};

enum class EREMINISCENE_STATE {
    eNONE = 0,
...
enum class EREQUEST_RESULT {
    eFAILED = 0,
    eSUCCESS = 1,
    EREQUEST_MAX = 2,
};

enum class EREQUEST_TYPE {
    eNONE = 0,
    eFIELD_TO_BATTLE = 1,
    eBATTLE_TO_FIELD = 2,
    eFIELD_TO_FIELD = 3,
...
enum class ESHOPMENU_RECEIVE_GIFT_STATE {
    eWAIT_DIALOG = 0,
...
enum class ESHOP_CATEGORY_TYPE {
    eAll = 0,
    eItem = 1,
    eWeapon = 2,
    eShield = 3,
...
enum class ESPACT_MERCHANT_TYPE {
    SPACT_MER_DUMMY = 0,
...
enum class ESPACT_MER_DESC_PARAM_TYPE {
    PARAM_NONE = 0,
    PARAM_INT_0 = 1,
    PARAM_INT_1 = 2,
    PARAM_INT_2 = 3,
...
enum class ESPACT_MER_RESULT_PARAM_TYPE {
    RESULT_NONE = 0,
    RESULT_LEAF = 1,
    RESULT_ITEM = 2,
    RESULT_MAX = 3,
...
enum class ESPACT_MER_RESULT_TYPE {
    NONE = 0,
    SUCCESS = 1,
    FAILURE = 2,
...
enum class ESPACT_MER_TRIGGER_TYPE {
    SHOP_BUY = 0,
    SHOP_SELL = 1,
    FC_PURCHASE = 2,
    INN = 3,
...
enum class ESTEALTH_DISEASE_TYPE {
    eSTEALTH_NORMAL = 0,
    eSTEALTH_STEAM = 1,
...
enum class ESTORY_NOTIFICATION_TYPE {
    eMARCHANT = 0,
    eCOUPLING = 1,
    ESTORY_NOTIFICATION_MAX = 2,
};

enum class ESTORY_SELECT_STATE {
    eNone = 0,
    eSelect_Story = 1,
    eOpening_Dialog = 2,
    eSelected_Story = 3,
...
enum class ESUB_STORY_CATEGORY {
    NONE = 0,
    COMMON = 1,
    MERCHANT = 2,
    ESUB_STORY_MAX = 3,
...
enum class ESUB_STORY_RADAR_ICON_TYPE {
    SUB_STORY = 0,
    MERCHANT = 1,
    EX_MAIN_STORY = 2,
...
enum class ESUPPORT_AILMENT_TYPE {
    eNONE = 0,
    eENCOUNT_DOWN = 1,
...
enum class ESWITCH_INDOOR_ANIM_STATE {
    NONE = 0,
    INDOOR = 1,
    OUTDOOR = 2,
...
enum class ESWITCH_INDOOR_TENPLATE_TYPE {
    eMANUAL = 0,
    eBASIC = 1,
    eCROSS_FLOOR = 2,
    eSAME_FLOOR = 3,
...
enum class ESaveDataLoadTarget {
    Normal = 0,
    Trial = 1,
    PS4 = 2,
...
enum class ESaveDataManagerState {
    NONE = 0,
    WAIT = 1,
    AUTO_SAVING = 2,
...
enum class ESequencerResourceData {
    SEQ_TEST = 0,
...
enum class EStaffCreditRunningState {
    NONE = 0,
    SCROLL = 1,
    TO_DISOLVE = 2,
    DISOLVE = 3,
...
enum class EStateMachineAction {
    ENTRY = 0,
    UPDATE = 1,
    EXIT = 2,
...
enum class ETIMEZONE_TRIGGER_TYPE {
    None = 0,
    eDAYTIME = 1,
    eNIGHT = 2,
    eALL = 3,
...
enum class ETRAKING_RELEASED_TYPE {
    eTOWN_OUTSIDE = 0,
    eCHANGE_TIMEZOON = 1,
    eFLAG_ON = 2,
    eFLAG_OFF = 3,
...
enum class ETRANSPORTATION_TYPE {
    NORMAL = 0,
    SHIP = 1,
    ETRANSPORTATION_MAX = 2,
};

enum class ETRANSPORT_EFFECT {
    WALK = 0,
    DASH = 1,
    EX_DASH = 2,
    STOP = 3,
...
enum class ETameMonsterMode {
    Manual = 0,
    Auto = 1,
    ETameMonsterMode_MAX = 2,
};

enum class ETimeZoneObjectType {
    eNONE = 0,
    eLIGHT = 1,
    eEMITTER = 2,
    eSOUND = 3,
...
enum class ETutorialAutoCaptureActorState {
    None = 0,
    Initialize = 1,
    PreCapture = 2,
    Capture = 3,
...
enum class EUIResType {
    TEXTURE2D = 0,
    STATICMESH = 1,
    EUIResType_MAX = 2,
};

enum class EUITitleFlow {
    eLogo = 0,
    eSystemLoad = 1,
    eDemo = 2,
    e1stTitle = 3,
...
enum class EUI_FIELD_COMMAND_TYPE {
    eDAYTIME = 0,
    eNIGHT = 1,
    EUI_FIELD_COMMAND_MAX = 2,
};

enum class EUI_INPUT_TYPE {
    eDECIDE = 0,
    eCANCEL = 1,
    eCURSOR_UP = 2,
    eCURSOR_DOWN = 3,
...
enum class EWEAPON_UNLOAD_GC_TYPE {
    eNONE = 0,
    eSTEP_OUT = 1,
    eTURN_END = 2,
    eBATTLE_END = 3,
...
enum class EWIDGET_CREATE_PHASE {
    NONE = 0,
    FIRST = 1,
    IN_GAME = 2,
    TEMPORARY = 3,
...
enum class EWIDGET_TEMPORARY_HIDE_USER {
    eOther = 0,
    eFieldCommand = 1,
    eTreasureBox = 2,
    eShop = 3,
...
enum class EWIPE_KIND {
    BATTLE_START_WIPE = 0,
    BATTLE_END_WIPE = 1,
    BATTLE_MAX = 2,
};

enum class EWidgetAnimationGroup {
    DefaultGroup = 0,
    EffectGroup = 1,
    EWidgetAnimationGroup_MAX = 2,
};

enum class EWorldMapEffectType {
    eDarkEffect = 0,
    eSacredFire = 1,
    eSacredFireLine = 2,
...
enum class EWorldMapGlobeState {
    eNone = 0,
    eInPreparation = 1,
    eControllable = 2,
    eInAutoControll = 3,
...
enum class EWorldMapIslandLayerArea {
    eNONE = 0,
    eISLAND_LAYER_01 = 1,
    eISLAND_LAYER_02 = 2,
    eISLAND_LAYER_03 = 3,
...
enum class EWorldMapMode {
    WorldMap = 0,
    PlayerSelect = 1,
    EWorldMapMode_MAX = 2,
};

enum class EWorldMapPrologueMaskArea {
    eNONE = 0,
    eDESERT_PROLOGUE = 1,
    eSNOW_PROLOGUE = 2,
...
enum class E_FIELDCOMMAND_BATTLE_DIALOG_TYPE {
    eBATTLE_CONFIRM = 0,
    eBATTLE_FAILED = 1,
...
enum class NPC_ITEM_OBTAIN_TYPE {
    PURCHASE = 0,
    STEAL = 1,
    BEG = 2,
    ROB = 3,
